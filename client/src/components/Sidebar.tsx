...
export default function Sidebar({
  ...
  return (
    <div className="w-80 bg-[var(--surface)] border-r border-slate-700 flex flex-col">
      ...
      {/* Shape Types Section */}
      <div className="p-6 border-b border-slate-700">
        <h2 className="text-sm font-semibold text-slate-300 mb-4 uppercase tracking-wide">Shape Types</h2>
      ...
      <div className="p-6 border-b border-slate-700">
        <h2 className="text-sm font-semibold text-slate-300 mb-4 uppercase tracking-wide">Transform Tools</h2>
      ...
      {/* Composition Section */}
      <div className="p-6 border-b border-slate-700">
        <h2 className="text-sm font-semibold text-slate-300 mb-4 uppercase tracking-wide">Composition</h2>
        <Button 
          onClick={onComposeShapes}
          disabled={!canComposeShapes}
          className="w-full bg-[var(--editor-accent)] hover:bg-purple-700 text-white font-medium mb-3 disabled:opacity-50 disabled:cursor-not-allowed"
        >
      ...
      <div className="p-6 flex-1 overflow-y-auto">
        <h2 className="text-sm font-semibold text-slate-300 mb-4 uppercase tracking-wide">Selection Info</h2>
