      ...
      <div className="w-16 bg-[var(--surface)] border-r border-slate-700 flex flex-col">
        ...
        <div className="flex-1 flex flex-col space-y-2 py-4">
          ...
          <Popover>
            ...
            <PopoverContent 
              side="right" 
              className="w-4 bg-slate-900 border-slate-700 p-2"
              onOpenAutoFocus={(e) => e.preventDefault()}
              onCloseAutoFocus={(e) => e.preventDefault()}
            >
              <div className="text-xs text-white font-medium">Shape Types</div>
            </PopoverContent>
          </Popover>
          ...
          <Popover>
            ...
            <PopoverContent 
              ...
              onCloseAutoFocus={(e) => e.preventDefault()}
            >
              <div className="text-xs text-white font-medium">Edit Mode</div>
            </PopoverContent>
          </Popover>
          ...
          <Popover>
            ...
            <PopoverContent 
              ...
              onCloseAutoFocus={(e) => e.preventDefault()}
            >
              <div className="text-xs text-white font-medium">Transform Tools</div>
            </PopoverContent>
          </Popover>
          ...
          <Popover>
            ...
            <PopoverContent 
              ...
              onCloseAutoFocus={(e) => e.preventDefault()}
            >
              <div className="text-xs text-white font-medium">Composition</div>
            </PopoverContent>
          </Popover>
          ...
          <Popover>
            ...
            <PopoverContent 
              ...
              onCloseAutoFocus={(e) => e.preventDefault()}
            >
              <div className="text-xs text-white font-medium">Artboards</div>
            </PopoverContent>
          </Popover>
          ...
          <Popover>
            ...
            <PopoverContent 
              ...
              onCloseAutoFocus={(e) => e.preventDefault()}
            >
              <div className="text-xs text-white font-medium">Boolean Operations</div>
            </PopoverContent>
          </Popover>
          ...
          <Popover>
            ...
            <PopoverContent 
              ...
              onCloseAutoFocus={(e) => e.preventDefault()}
            >
              <div className="text-xs text-white font-medium">Color Manipulation</div>
            </PopoverContent>
          </Popover>
          ...
          <Popover>
            ...
            <PopoverContent 
              ...
              onCloseAutoFocus={(e) => e.preventDefault()}
            >
              <div className="text-xs text-white font-medium">Layers</div>
            </PopoverContent>
          </Popover>
