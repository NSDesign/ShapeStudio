...
export class BooleanOperations {
  ...
  static canPerformGeometricOperation(shape1: Shape, shape2: Shape): boolean {
    ...
    const supportedTypes = ['rectangle', 'rounded-rectangle', 'square', 'rounded-square', 'circle', 'ellipse', 'polygon', 'star', 'ring', 'blob', 'spline-circle', 'spline-ellipse', 'spline-ring', 'bezier'];
